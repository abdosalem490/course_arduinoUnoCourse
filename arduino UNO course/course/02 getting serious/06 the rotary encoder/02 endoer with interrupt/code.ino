 ...
 *  ---------
 *  Encoder.h
 *	the library name is : encoder by paul stoffregen
 *
 * Connections
 * -----------
 * Very important note : don't forget to connect the 5V to the encoder otherwise , if you  try to rotate the encoder in the opposite direction , it will not decrease its readings
 *  
